...
if (FAST$1.getById === void 0) {
  ...
  Reflect.defineProperty(FAST$1, "getById", Object.assign({
    value(id, initialize) {
...
const Updates = FAST$1.getById(KernelServiceId.updateQueue, () => {
  const tasks = [];
  const pendingErrors = [];
...
const Observable = FAST$1.getById(KernelServiceId.observable, () => {
...
const contextEvent = FAST$1.getById(KernelServiceId.contextEvent, () => {
  let current = null;
  return {
    get() {
      return current;
...
const fastElementRegistry = FAST$1.getById(KernelServiceId.elementRegistry, () => createTypeRegistry());
/**
...
const debugMessages = {
  [1101
  /* needsArrayObservation */
  ]: "Must call enableArrayObservation before observing arrays.",
  [1201
  /* onlySetDOMPolicyOnce */
  ]: "The DOM Policy can only be set once.",
  [1202
  ...
  ]: "Unable to autoregister dependency.",
  [1505
  /* cannotResolveKey */
  ]: "Unable to resolve dependency injection key '${key}'.",
  [1506
